...
import { Users, Building2, UserCircle, Settings, Home, LogOut, Moon, Sun, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <motion.aside
        ...
        className={`w-64 bg-sidebar text-sidebar-foreground flex flex-col shadow-lg ${isRTL ? 'border-l' : 'border-r'}`}
      >
        {/* Logo */}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-card border-b border-border px-8 py-4">
          <div className={`flex items-center justify-between ${isRTL ? 'flex-row-reverse' : 'flex-row'}`}>
            <h1 className={`text-xl font-semibold text-foreground ${isRTL ? 'text-right' : 'text-left'}`}>
