...
public interface ICandidateAdminService
{
    ...
    Task<PagedResult<CandidateAdminResponseDto>> GetAllCandidatesAsync(int pageNumber = 1, int pageSize = 10);
    ...
    Task<PagedResult<CandidateAdminResponseDto>> SearchCandidatesAsync(CandidateSearchDto searchDto);
...
public interface ICompanyAdminService
{
    ...
    Task<PagedResult<CompanyAdminResponseDto>> GetAllCompaniesAsync(int pageNumber = 1, int pageSize = 10);
    ...
    Task<PagedResult<CompanyAdminResponseDto>> SearchCompaniesAsync(CompanySearchDto searchDto);
