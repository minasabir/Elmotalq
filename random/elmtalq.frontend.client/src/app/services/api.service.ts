...
export class ApiService {
  ...
  getHealth(): Observable<HealthResponse> {
    return this.http.get<ApiResponse<HealthResponse>>(`${this.apiUrl}/Elmtalq/Health`)
      .pipe(
        map(response => response.data as HealthResponse),
  ...
  getTest(): Observable<TestResponse> {
    return this.http.get<ApiResponse<TestResponse>>(`${this.apiUrl}/Elmtalq/Test`)
      .pipe(
        map(response => response.data as TestResponse),
        catchError(this.handleError)
      );
  }
  ...
  createCompany(company: CompanyCreateDto): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(`${this.apiUrl}/Elmtalq/Companies`, company, this.httpOptions)
      .pipe(
